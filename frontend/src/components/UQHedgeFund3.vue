    ...
    <q-dialog v-model="alert" persistent transition-show="scale" transition-hide="scale">
      <q-card style="width: 800px; max-width: 80vw;">
        ...
        <q-card-section class="text-center q-pb-none q-pa-md">
          ...
          >From which account do you want to fund your investment?</div>
        </q-card-section>
            ...
            <div class="q-pa-sm">
                  ...
                  <div v-if="wallet.balance > 0">
                    <div class="cont-shadows q-mb-md q-pa-md">
                      <div class="row">
                        ...
                        <div class="col-12 col-sm-3 text-left q-mt-lg">
                          <span class="text-h6 q-ml-sm">
                            <b>${{ (wallet.balance / 10 ** wallet.decimal_places * conversion[wallet.currency]).toLocaleString('en-US', {maximumFractionDigits: 2, minimumFractionDigits: 2 }) }}</b>
                          </span>
                        </div>
              ...
              <div id="desktop-balance-container" class="row">
                <div class="col">
                  ...
                  <div class="text-left">
                  <span id="balance-label-text" class="text-h6">
                    Total Lexicon Tokens:
                    <b>
                       {{totalToken.toLocaleString("en-US", {
                      minimumFractionDigits:2, maximumFractionDigits: 2})}}
                    </b>
                  </span>
                </div>
...
export default {
  ...
  methods: {
    ...
    triggerPositiveCanceled(position, orderNumber) {
      this.$q.notify({
        type: "positive",
        message: `Your  ${orderNumber} Successfully!`,
        position,
      });
    },
